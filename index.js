...
// Mock for a User's Spreadsheet (Replaces SpreadsheetApp)
class InMemorySheet {
    ...
    getRange(row, col, numRows = 1, numCols) {
        ...
        return {
            ...
            clearContent: () => { /* Simple mock clear */ }
        };
    }
    ...
    clearContents() { this.data = [this.data[0].slice()]; }
    getSheetId() { return this.name.length; } // Simple mock ID
}
